...
function App() {
  return (
    <BrowserRouter>
      <div className="font-bold border-x rounded-lg bg-[url('/pexels-david-bartus-43782-2290438.jpg')] bg-cover inline-block bg-gradient-to-r from-black/90 via-black/60 to-transparent">
        <div className="flex flex-col bg-[rgba(0,0,0,0.38)] font-medium rounded-lg border-x ">
